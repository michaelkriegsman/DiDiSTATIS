...
DESIGN$rows$Composer_colors_B  <- prettyGraphsColorSelection(3, offset=3) #prettyGraphs::createColorVectorsByDesign(DESIGN$rows$Composers_mat)$gc
DESIGN$rows$Composer_colors_AB <- rep(prettyGraphsColorSelection(3, offset=3), each=12) #prettyGraphs::createColorVectorsByDesign(DESIGN$rows$Composers_mat)$oc
```
...
res_HMFA <- HMFA(D2_array, DESIGN_tables = DESIGN$tables$MusExp_mat, main = "FreeSort36 Composers")
