...
#prettyGraphs::createColorVectorsByDesign(DESIGN$rows$Composers_mat)$oc
```
...
res_DiSTATIS <- DiSTATIS(D2_array, DESIGN_tables = DESIGN$tables$MusExp_mat, main = "FreeSort36 Composers")
