#Initialize_Dowling_Balanced_Constrained_NaturalStimuli_ArousalValence_Example.R

SortConstrained_36 <- read.csv('C:/Users/Michael A. Kriegsman/Google Drive/Projects/DiDiSTATIS_Composers/WithMoreSubj_ForDissertation/natural36_constrained_forR.csv', row.names=1)
Sort <- SortConstrained_36[-37,]
MusExp <- t(SortConstrained_36[37,]) #subjects' musical experience
